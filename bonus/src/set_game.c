...
/*   Updated: 2024/06/27 13:16:50 by bgoron           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_data(t_data *d)
{
	...
	init_menu(d);
	s->path_ceiling = "textures/wall/x.png"; // TODO change path
	...
	g->img_mini_map = mlx_new_image(g->mlx, WIN_WIDTH * 0.17, WIN_HEIGHT * 0.28);
}
